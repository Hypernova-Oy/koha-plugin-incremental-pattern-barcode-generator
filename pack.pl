...
use Koha::Plugin::Com::Theke::BarcodeGenerator;
my $version  = $Koha::Plugin::Com::Theke::BarcodeGenerator::VERSION;
my $filename = "/tmp/koha-plugin-incremental-pattern-barcode-generator-$version.kpz";
